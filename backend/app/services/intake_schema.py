...
SECCIONES = [
    ...
    },
    {
        ...
        "en_config": True,
        "campos": [
            {"id": "que_vende", "label": "En una frase, ¿qué vende la empresa?", "tipo": "text", "oblig": True, "ayuda": "Ej: \"Venta mayorista de insumos de oficina\" · \"Software de gestión para PyMEs\" · \"Distribución de alimentos a restaurantes\""},
            ...
            {"id": "categorias", "label": "Categorías de producto o servicio que ofrecen", "tipo": "textarea", "oblig": True, "ayuda": "Las líneas o familias de lo que vendés (productos o servicios)"},
    ...
    },
    {
        ...
        "en_config": True,
        "campos": [
            {"id": "a_quien_vende", "label": "¿A qué tipo de empresa/persona le vendés?", "tipo": "textarea", "oblig": True, "ayuda": "Ej: comercios, fábricas, oficinas, profesionales, restaurantes, instituciones…"},
            ...
            {"id": "senales_buen_candidato", "label": "Señales de que un prospect es buen candidato", "tipo": "textarea", "oblig": True, "ayuda": "Ej: tiene local/oficina propia, varios empleados, compra de forma recurrente, está creciendo"},
            {"id": "senales_compra", "label": "Señales de compra / urgencia a detectar", "tipo": "textarea", "oblig": False, "ayuda": "Ej: abrió una sucursal, lanzó un producto nuevo, está contratando, publicó una búsqueda relacionada"},
    ...
    },
    {
        ...
        "en_config": True,
        "campos": [
            {"id": "como_buscarias_google", "label": "¿Cómo buscarías en Google a un cliente tuyo?", "tipo": "textarea", "oblig": True, "ayuda": "Las palabras que vos pondrías para encontrar un cliente. Ej: \"imprenta zona norte\", \"estudio contable Rosario\""},
    ...
    },
    {
        ...
        "campos": [
            ...
            {"id": "empresa_nombre_msg", "label": "¿Cómo se nombra a la empresa en el mensaje?", "tipo": "text", "oblig": True, "ayuda": "El nombre con el que el agente se presenta. Ej: \"te escribo de [tu empresa]\""},
