...
_CONTEXTO_COSTO = (
    ...
    "funcionando saldría +24 a +38% MÁS CARO (el write 1h cuesta 2× y solo ~19% de "
    "las re-escrituras cae en la ventana 5-60min rescatable; el resto es arranque en "
    "frío + huecos >1h). No lo recomiendes bajo ninguna forma (ni 'activar TTL largo', "
    ...
    "remedio nuevo y distinto a los descartados.\n"
